    ...
    <form action="{{ route('events.update', $event) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div>
            ...
            <textarea name="description" id="description" rows="3"
                      class="input-base">{{ old('description', $event->description) }}</textarea>
        </div>
        ...
        <div>
            ...
            <input type="file" name="poster" id="poster" accept="image/*"
                   class="input-base file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700">
