...
<div class="max-w-xl mx-auto my-12">
    <div class="bg-white rounded-3xl shadow-lg p-8">
        ...
        <form method="POST" action="{{ route('places.update', $place) }}" class="space-y-6">
            ...
            <div>
                <label for="address" class="block font-semibold text-yellow-700 mb-1">Adresse</label>
            ...
            <div>
                <label for="description" class="block font-semibold text-yellow-700 mb-1">Description</label>
                <textarea name="description" id="description" rows="3"
                    class="w-full border-2 border-yellow-300 rounded-lg px-4 py-2 text-gray-900 placeholder-gray-600 focus:border-yellow-600 focus:ring-2 focus:ring-yellow-200 transition">{{ old('description', $place->description) }}</textarea>
